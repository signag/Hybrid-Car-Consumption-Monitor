//=============================================================================================================
// This function analyzes the short term trips with respect to fuel consumption
// Only mixed Fuel/electric trips are considered
...
option task = {name: "HCCM_FuelMixed", every: 5m}
...
consumptionFuelFromTrips = () => {
    ...
    ret =
        ...
        from(bucket: "Car_Trips")
            ...
            // we only keep the ones where fuel has been consumed.
            ...
            |> set(key: "process", value: "engine")
            |> set(key: "source", value: "tripMixed")
...
cons = if chargingFinished() then consumptionFuelFromTrips() else consNul
